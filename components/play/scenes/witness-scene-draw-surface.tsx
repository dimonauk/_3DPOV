...
/**
 * components/play/scenes/witness-scene-draw-surface.tsx — Pointer-driven
 * draw surface for the Witness level. Raycasts onto an in-camera plane and
 * reports world-space points + commit boundaries. State + storage live in
 * the parent scene.
 */
...
import { TRAIL_PLANE_DISTANCE } from "./witness-scene-narration";
