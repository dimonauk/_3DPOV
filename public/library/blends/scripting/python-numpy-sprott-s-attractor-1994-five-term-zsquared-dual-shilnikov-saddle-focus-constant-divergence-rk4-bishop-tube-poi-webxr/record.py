"""
record.py — Viewport animation for Sprott S Attractor
======================================================
...
SLUG = (
    "python-numpy-sprott-s-attractor-1994-five-term-zsquared-"
    "dual-shilnikov-saddle-focus-constant-divergence-rk4-bishop-tube-poi-webxr"
)
...
# ── Shape-key morph ───────────────────────────────────────────────────────
obj = bpy.data.objects.get("hf_sprott_s_poi")
if obj and obj.data.shape_keys:
    ...
    morph_schedule = [
        ("SK_LowC",  30, 50, 65, 80),
        ("SK_HighC", 75, 95, 110, 125),
        ("SK_WideC", 120, 135, 145, 150),
    ]
