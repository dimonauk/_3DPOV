 ...
 *
 * The AI Gateway routes our `model` string ("openai/gpt-5.4" by
 ...
 *
 * Model selection:
 *   AI_GATEWAY_MODEL_VISION  e.g. "openai/gpt-5.4" (default)
...
const VISION_MODEL =
  process.env.AI_GATEWAY_MODEL_VISION ?? "openai/gpt-5.4";
