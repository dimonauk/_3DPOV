...
import { entry as blenderTutorialPythonBpyAppHandlersPersistentEventHooksWebxrEntry } from "components/tutorials/entries/blender-tutorial-python-bpy-app-handlers-persistent-event-hooks-webxr";
...
const ENTRIES: Entry[] = [
  ...
  blenderTutorialPythonBpyAppHandlersPersistentEventHooksWebxrEntry,
];
