...
| 4 | **Aerial editorial / 360 / FPV commissions** | `app/aerial/page.tsx` + `components/articles/entries/the-fleet-four-airframes.tsx` | Five-airframe CAA-registered aerial line, editorial stills + B-roll + 360 fly-throughs. | One-time per shoot | £450 half-day · £750 full-day + travel @ HMRC mileage | Medium — structured brief intake; recce/quote turnaround; deliverable framework (TIFF/JPEG/ProRes/equirectangular) | New `/services/aerial/quote`, downloadable spec sheet, scheduling note | Editorial outlets, architectural clients, performance collectives, venues. |
