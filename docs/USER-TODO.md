...
- [x] **Flip GitHub default branch** to `main` — done 2026-05-20.
- [x] **Flip Vercel production branch** to `main` — done 2026-05-20.
...
- [ ] **The 24/7 Blender Content Mill** is at [the routine page](https://claude.ai/code/routines/trig_01WHz2JCSPTWKqKGVKGDbepj)
...
- **Vercel deployments** — [vercel.com/.../holo-flow-studio/deployments](https://vercel.com/dimonauk-9379s-projects/holo-flow-studio/deployments)
- **The branch** — `git log --oneline -20 origin/main` shows the last 20 commits
- **The 24/7 routine** — [claude.ai/code/routines/trig_01WHz2JCSPTWKqKGVKGDbepj](https://claude.ai/code/routines/trig_01WHz2JCSPTWKqKGVKGDbepj)
