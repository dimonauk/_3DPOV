...
/**
 * app/play/pixel-academy/pixel-academy/office-canvas.tsx — The
 * tile-based renderer + interaction surface for the Pixel Academy
 * chamber.
 *
 * Ported verbatim from `D:/The_Hangar/apps/pixel-academy/src/
 * OfficeCanvas.tsx`, minus the Scribe Bridge hook. Edit-mode props
 * are inlined as no-ops because the chamber does not surface the
 * editor.
 *
