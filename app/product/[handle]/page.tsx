  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-(--breakpoint-2xl) px-4">
        <div className="flex flex-col rounded-lg border border-warm-black-800 bg-warm-black-900/60 p-6 md:p-10 lg:flex-row lg:gap-10">
...
async function RelatedProducts({ id }: { id: string }) {
  ...
  return (
    <section className="py-10">
      <div className="chrome-label">Adjacent works</div>
      <h2 className="mt-2 mb-6 text-2xl">Related objects.</h2>
